...
app.post("/submit", (req, res) => {
  ...
  const adjName = adj[Math.floor((Math.random() * adj.length) + 1)]
  const nounName = noun[Math.floor((Math.random() * noun.length) + 1)]
  
  res.render("index.ejs" , {randomName : `${adjName} ${nounName}`})
